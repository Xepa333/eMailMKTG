...
const TestingModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  if (!isOpen) {
    return null;
  }
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <div>
            <h2 id="testing-modal-title" className="text-3xl font-bold text-indigo-900 mb-6">10 Test, optimize, test again, optimize, again, test</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Don't just preview in a web browser</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Different email providers display emails different</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Test at least the main email providers</p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-center justify-center bg-gray-50 rounded-lg p-4 lg:p-6 border border-gray-200">
            <img 
              src="https://storage.googleapis.com/generative-ai-projen-testing/user-images/image_09292a87-2195-4654-8c01-7667d7107775.png"
              alt="Logos of major email providers including Gmail, Outlook, Apple Mail, and Android" 
