...
const ImageryModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    <div 
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="imagery-modal-title"
    >
      <div 
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <div>
            <h2 id="imagery-modal-title" className="text-3xl font-bold text-indigo-900 mb-6">8 Imagery</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Refrain from putting text within an image</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Double the size of images for iOS Retina display images</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Use natural photography (not posed), screen-shots and medical shots</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Animated GIFs can be effective at drawing attention to a particular element, and can work well as a call to action</p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-center justify-center bg-gray-50 rounded-lg p-4 lg:p-6 border border-gray-200">
            <img 
              src="https://storage.googleapis.com/generative-ai-projen-testing/user-images/image_31f9f23e-6351-4b14-8785-32e78367d56e.png"
              alt="Two example images for use in emails, one of a medical consultation and another of a person" 
