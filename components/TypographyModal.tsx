...
const TypographyModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  if (!isOpen) {
    return null;
  }
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <div>
            <h2 id="typography-modal-title" className="text-3xl font-bold text-indigo-900 mb-6">4 Typography</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Readability on different screen sizes</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Use standard web safe fonts</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">To get the main message immediately across the main header should ideally be no smaller than 20px and the body text to 13px</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Use high contrast text, black or dark colours on a light background</p>
              </li>
            </ul>
             <a href="https://blog.hubspot.com/marketing/psychology-of-color" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline mt-8 block">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
             <img 
              src="https://storage.googleapis.com/generative-ai-projen-testing/user-images/image_388b3941-7998-4c81-8b27-0c7f1a30f368.png" 
              alt="Examples of high and low contrast text, and a table of color contrast ratio examples." 
