...
const UniformityModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  if (!isOpen) {
    return null;
  }
  ...
  return (
    <div 
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="uniformity-modal-title"
    >
      <div 
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <div>
            <h2 id="uniformity-modal-title" className="text-3xl font-bold text-indigo-900 mb-6">5 Uniformity</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Constant design elements, logos, titles, headers and footers appear in the same place, giving a consistent appearance to every email message</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Keep it narrow (600px width)</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Template system</p>
              </li>
              <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Clean and simple design</p>
              </li>
               <li className="flex items-start">
                <span className="text-indigo-600 font-bold text-2xl mr-3 mt-1">•</span>
                <p className="text-lg text-gray-700">Keep a good balance between text and images in the top part of your email</p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-center justify-center bg-gray-50 rounded-lg p-4 lg:p-6 border border-gray-200">
            <img 
              src="https://storage.googleapis.com/generative-ai-projen-testing/user-images/image_0940733a-d65e-4b8b-84a1-8d262ed4715f.png"
              alt="Two examples of emails demonstrating uniform design and layout" 
...
export default UniformityModal;